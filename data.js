    ...
    accordion: [
      {
        ...
        items: [
          ...
          { label: { tr: "Tongariro National Park (Mount Doom / Mount Ngauruhoe ve Tongariro Alpine Crossing yürüyüş parkuru)", en: "Tongariro National Park (Mount Doom / Mount Ngauruhoe and the Tongariro Alpine Crossing hike)" } },
          ...
          { label: { tr: "Kaitoke Regional Park / Rivendell (Wellington yakını, Elf diyarının çekildiği orman)", en: "Kaitoke Regional Park / Rivendell (near Wellington, the forest where the Elf realm was filmed)" } },
      ...
      },
      {
        ...
        items: [
          ...
          { label: { tr: "Glenorchy / Paradise (Isengard ve Lothlórien sahnelerinin çekildiği yer, Queenstown yakını)", en: "Glenorchy / Paradise (where the Isengard and Lothlórien scenes were filmed, near Queenstown)" } },
          { label: { tr: "Mount Sunday / Edoras (Rohan başkentinin çekildiği tek başına duran tepe, Canterbury)", en: "Mount Sunday / Edoras (the standalone hill where Rohan's capital was filmed, Canterbury)" } },
