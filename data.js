...
const TOPICS = [
  {
    ...
    intro: {
      tr: `Türkiye'den Yeni Zelanda'ya gelmek isteyenler için en sık sorulan soru budur: hangi yol yasal ve gerçekçi? Yeni Zelanda'nın vize sistemi, kimin hangi yolu kullanabileceğini duruma göre belirler; genel olarak dört ana yol var.<br><br><strong>Çalışma Tatili Vizesi (Working Holiday):</strong> Türkiye ile Yeni Zelanda arasında özel bir anlaşma var, 18-30 yaş arasındakiler bu vizeyle bir yıla kadar çalışıp seyahat edebiliyor. Başvuru koşulları ve kontenjan yıldan yıla değişebiliyor.<br><br><strong>Öğrenci Vizesi:</strong> Yeni Zelanda'da tanınan bir kuruma kayıt olarak alınıyor; bazı öğrenci vizeleri sınırlı çalışma hakkı da tanıyor, mezuniyet sonrası çalışma vizesine geçiş yolu da mevcut.<br><br><strong>Sponsorlu Çalışma Vizesi (Akredite İşveren – AEWV):</strong> Yeni Zelanda'da akredite olmuş bir işverenden iş teklifi alarak başvurulan yol; işveren sponsorluğu şart, süreç işverenin akreditasyonuna ve pozisyonun şartlarına bağlı.<br><br><strong>Partner Vizesi:</strong> Yeni Zelanda vatandaşı veya kalıcı oturum sahibi biriyle ciddi ve kanıtlanabilir bir ilişkisi olanlar için.<br><br>Her yolun kendi belge, süre ve uygunluk şartları var; hangisinin sana uyduğunu görmek ve her birine dair resmi kaynaklara ulaşmak için <a href="/topic.html?t=vize-sureclari">Vize Türleri &amp; Resmi Süreçler</a> sayfasına bakabilirsin. Amaç seni belirli bir yola yönlendirmek değil, hangi seçeneklerin gerçekten var olduğunu net şekilde göstermek — nihai ve güncel şartlar için her zaman Immigration New Zealand'ın resmi sayfaları esas alınmalı.`,
      en: `For anyone thinking about moving from Turkey to New Zealand, the first question is always the same: which path is legal and realistic? New Zealand's visa system decides who can use which route depending on their situation; broadly, there are four main paths.<br><br><strong>Working Holiday Visa:</strong> Turkey has a special agreement with New Zealand, letting people aged 18-30 work and travel for up to a year. Eligibility details and quotas can change year to year.<br><br><strong>Student Visa:</strong> Obtained by enrolling at a recognised New Zealand institution; some student visas also allow limited work rights, with a pathway to a post-study work visa after graduation.<br><br><strong>Sponsored Work Visa (Accredited Employer Work Visa – AEWV):</strong> Applied for with a job offer from an accredited employer in New Zealand; employer sponsorship is required, and the process depends on the employer's accreditation and the role's requirements.<br><br><strong>Partner Visa:</strong> For people in a genuine, evidenced relationship with a New Zealand citizen or resident.<br><br>Each route has its own documents, timelines and eligibility rules; to see which one fits you and find official sources for each, check the <a href="/en/topic.html?t=vize-sureclari">Visa Types &amp; Official Processes</a> page. The goal isn't to steer you toward one path, but to show clearly what options actually exist — for final, up-to-date requirements, always defer to Immigration New Zealand's official pages.`,
    },
    videos: [],
  ...
  },
  {
    ...
    intro: {
      tr: "Yeni Zelanda'da ne kadar kazanılır, vergi sistemi nasıl işler, eline geçen maaş beklediğinden ne kadar farklı olur? Vergi, işverenin maaşından otomatik olarak keser (PAYE sistemi); ayrıca çoğu çalışanın maaşından KiwiSaver adında bir emeklilik tasarrufu da kesilir. Aşağıdaki resmi kaynaklardan güncel oranları ve asgari ücreti kontrol edebilirsin.",
      en: "How much do people actually earn in New Zealand, how does the tax system work, and how different is your take-home pay from what you expect? Tax is deducted automatically from your pay by your employer (the PAYE system); most employees also have a retirement savings scheme called KiwiSaver deducted from their pay. Check the official sources below for current rates and the minimum wage.",
    },
    accordion: [
      {
