...
const TOPICS = [
  ...
  },
  {
    ...
    pinned: [
      ...
      {
        tone: "light",
        tr: `<span class="pinned-highlight-title">YÜZÜKLERİN EFENDİSİ &amp; HOBBİT ÇEKİM YERLERİ</span><p>Yeni Zelanda'nın dünya çapında en bilinen yönü — 45 yerin 5'i bu evrenden:</p><ul><li><strong>Hobbiton</strong> (Matamata) — Hobbit köyü film seti</li><li><strong>Tongariro</strong> — Mount Doom / Mount Ngauruhoe</li><li><strong>Kaitoke Regional Park</strong> (Wellington yakını) — Rivendell</li><li><strong>Glenorchy / Paradise</strong> (Queenstown yakını) — Isengard, Lothlórien</li><li><strong>Mount Sunday</strong> (Canterbury) — Edoras, Rohan başkenti</li></ul>`,
        en: `<span class="pinned-highlight-title">LORD OF THE RINGS &amp; HOBBIT FILMING LOCATIONS</span><p>New Zealand's most globally recognised side — 5 of the 45 places on this list are from this world:</p><ul><li><strong>Hobbiton</strong> (Matamata) — the Hobbit village set</li><li><strong>Tongariro</strong> — Mount Doom / Mount Ngauruhoe</li><li><strong>Kaitoke Regional Park</strong> (near Wellington) — Rivendell</li><li><strong>Glenorchy / Paradise</strong> (near Queenstown) — Isengard, Lothlórien</li><li><strong>Mount Sunday</strong> (Canterbury) — Edoras, capital of Rohan</li></ul>`,
      },
    ],
    videos: [],
