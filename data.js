...
const TOPICS = [
  ...
  },
  {
    ...
    intro: {
      tr: `Yeni Zelanda'da ne kadar kazanılır, vergi sistemi nasıl işler, eline geçen maaş beklediğinden ne kadar farklı olur? Vergiyi işveren maaşından otomatik olarak keser, buna PAYE sistemi denir. Çoğu çalışanın maaşından ayrıca KiwiSaver adında bir emeklilik tasarrufu da kesilir. Güncel oranları ve asgari ücreti aşağıdaki resmi kaynaklardan kontrol edebilirsin. İşe başladığında haklarını bilmek de en az maaş kadar önemli, bunun için <a href="/topic.html?t=isci-haklari">İşçi Hakları</a> sayfasına bakabilirsin.`,
      en: `How much do people actually earn in New Zealand, how does the tax system work, and how different is your take-home pay from what you expect? Tax is deducted automatically from your pay by your employer, this is called the PAYE system. Most employees also have a retirement savings scheme called KiwiSaver deducted from their pay. Check the official sources below for current rates and the minimum wage. Knowing your rights once you start working matters just as much as your pay, see the <a href="/en/topic.html?t=isci-haklari">Worker Rights</a> page.`,
    },
    accordion: [
      {
    ...
    accordion: [
      {
        ...
        items: [
          ...
          { label: { tr: "Hobbiton Movie Set (Matamata - Yüzüklerin Efendisi köyü)", en: "Hobbiton Movie Set (Matamata - the Lord of the Rings village)" } },
          ...
          { label: { tr: "Tongariro National Park (Tongariro Alpine Crossing yürüyüş parkuru)", en: "Tongariro National Park (Tongariro Alpine Crossing hike)" } },
