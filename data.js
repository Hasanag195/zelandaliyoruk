...
const TOPICS = [
  {
    ...
    intro: {
      tr: "Türkiye'den Yeni Zelanda'ya gelmek isteyenler için en sık sorulan soru budur: hangi yol yasal ve gerçekçi? Ana yollar şunlar: çalışma tatili vizesi (Türkiye'ye özel, 18-30 yaş), öğrenci vizesi, bir işverenden sponsorlu çalışma vizesi ve partner vizesi (Yeni Zelanda vatandaşı/residenti ile). Her birinin şartı farklı, hangisinin sana uyduğunu görmek için aşağıdaki Vize Türleri sayfasına bakabilirsin. Amaç seni yönlendirmek değil, hangi seçeneklerin var olduğunu net şekilde göstermek.",
      en: "For anyone thinking about moving from Turkey to New Zealand, the first question is always the same: which path is legal and realistic? The main routes are: the working holiday visa (special agreement for Turkey, ages 18-30), a student visa, a sponsored work visa from an employer, and a partner visa (with a New Zealand citizen/resident). Each has different requirements — see the Visa Types page below to check which applies to you. The goal isn't to tell you what to do, but to show you clearly what your options are.",
    },
    videos: [],
