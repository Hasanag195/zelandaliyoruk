  ...
  tr: [
    {
      ...
      items: [
        ...
        { t: "\"Bağlantım var, hızlandırırım\" diyen kimseye güvenme, böyle bir yetki kimsede yoktur", link: ["dolandırıcılık rehberi", "t/dolandiriciliklardan-korunma.html"] },
    ...
    },
    {
      ...
      items: [
        ...
        { t: "İşe başladığında haklarını bil", link: ["İşçi Hakları sayfası", "t/isci-haklari.html"] },
        { t: "Vize süren bitmeden önce uzatma/geçiş planını netleştir" },
        { t: "Oturum izni (residence) yollarını araştır", link: ["Vize Türleri sayfası", "t/vize-sureclari.html"] },
      ],
    },
  ],
  en: [
    {
      ...
      items: [
        ...
        { t: "Don't trust anyone who says \"I have connections, I'll speed it up\", no one has that authority", link: ["scam prevention guide", "t/dolandiriciliklardan-korunma.html"] },
    ...
    },
    {
      ...
      items: [
        ...
        { t: "Know your rights once you start working", link: ["Worker Rights page", "t/isci-haklari.html"] },
        { t: "Clarify your extension/transition plan before your visa expires" },
        { t: "Research pathways to residence", link: ["Visa Types page", "t/vize-sureclari.html"] },
      ],
    },
  ],
};
